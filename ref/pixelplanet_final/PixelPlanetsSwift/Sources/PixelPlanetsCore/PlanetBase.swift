...
open class PlanetBase: @unchecked Sendable {
    ...
    private func colors(for binding: ColorBinding) -> [Color] {
    ...
    private func setColors(_ colors: [Color], for binding: ColorBinding) {
    ...
    public func colorsPalette() -> [Color] {
    ...
    open func randomizeColors(rng: inout RandomStream) -> [Color] {
