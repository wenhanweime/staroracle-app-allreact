...
public final class StarPlanet: PlanetBase, @unchecked Sendable {
    ...
    public override func randomizeColors(rng: inout RandomStream) -> [Color] {
        ...
        if palette.count < 4 {
            palette += Array(repeating: Color(r: 1, g: 0.8, b: 0.4, a: 1), count: 4 - palette.count)
        }
...
public final class TwinkleStarPlanet: PlanetBase, @unchecked Sendable {
    ...
    public override func randomizeColors(rng: inout RandomStream) -> [Color] {
        ...
        if corePalette.count < 4 {
            corePalette += Array(repeating: Color(r: 1, g: 0.9, b: 0.6, a: 1), count: 4 - corePalette.count)
        }
        ...
        let sparkA = gradient.first ?? Color(r: 1, g: 0.95, b: 0.8, a: 1)
