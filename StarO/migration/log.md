...
- 会话标题更像“人话”：优化会话标题生成提示词与后处理，避免产出“关于…的对话/聊天/讨论”等模板；并改进 mock/降级路径标题生成，确保即使走兜底也更可读（`StarO/StarO/AppEnvironment.swift`、`ios-native/Packages/StarOracleServices/.../MockServices.swift`）。
