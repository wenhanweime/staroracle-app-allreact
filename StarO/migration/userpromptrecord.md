...
# 48（已读 2025-12-21 22:08）
【用户输入原文】
> 对于绘画标题的总结,非常死板,都是关于xxx的对话,我们应该通过大模型总结对话名称,给出更容易理解的名字

【任务拆解】
- [x] 会话标题生成：优化 LLM 提示词与后处理，避免“关于…的对话”模板，输出更像短语的标题（<=12字）（已完成 2025-12-21 22:09）
- [x] 兜底标题生成：Mock/降级路径不再产出“关于…的对话”，改为更可读的短标题（已完成 2025-12-21 22:09）

# 49（已读 2025-12-22 02:51）
【用户输入原文】
> 现在我设置了新的头像,但是发现拉出左panel或者点击头像进入个人主页,都还会短暂弹出F字母的头像,这个体验很差,帮我分析原因并解决
